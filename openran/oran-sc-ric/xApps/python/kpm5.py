...
class KpmStyle5Xapp(xAppBase):
    ...
    """
    def __init__(self, config, http_server_port, rmr_port, metrics_dir, csv_filename="kpm_style5_metrics.csv"):
        ...
        if not os.path.exists(self.csv_filepath):
            try:
                with open(self.csv_filepath, mode='w', newline='') as csv_file:
                    ...
                    header = ["Timestamp", "E2AgentID", "SubscriptionID", "UE_ID", "GranularityPeriod_ms"] + metric_names
...
if __name__ == '__main__':
    ...
    parser.add_argument("--metrics_dir", type=str, default=METRICS_DIR, help="Directory to save the metrics CSV file")
